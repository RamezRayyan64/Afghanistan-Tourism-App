import 'package:afghanistan_tourism_app/screens/home_screens/main_home_screen/sub_screens/touristic_city_about_screen/bottom_navigation_bar_screens/touristic_city_places_screen/widgets/touristic_city_place_name_location_widgets.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          TouristicCityPlaceStarRatingRowWidgets(
